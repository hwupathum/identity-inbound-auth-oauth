 ...
 */
public class ImpersonatorPermissionValidatorTest extends PowerMockIdentityBaseTest {
    ...
    public void testValidateImpersonationNegativeCase() throws IdentityException, NoSuchFieldException,
        ...
        assertFalse(impersonationContext.isValidated(), "Impersonation context's validated attribute should be false");
